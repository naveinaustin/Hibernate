...
public class VersionTestTemp 
{
	public void testVersionShortCircuitFlush() {
		...
		System.out.println( passp.getVersion());
	...
	public void testCollectionVersion() {
		...
		System.out.println(gavin.getVersion());
		...
		System.out.println( gavin.getVersion());
		System.out.println( Hibernate.isInitialized( gavin.getThings() ) );
	...
	public void testCollectionNoVersion() {
		...
		System.out.println( gavin.getVersion());
		System.out.println( Hibernate.isInitialized( gavin.getTasks() ) );
